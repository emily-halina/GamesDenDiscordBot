            ...
            if curse in content:
                if str(message.author) == "AttacktoWin#7991":
                    await message.channel.send(
                        "Hey, please check your mess- Oh, I'm sorry Mr. President, I didn't realize it was you! I'll look the other way this time but please watch your language in the future!"
                    )
                else:
                    await message.channel.send(
